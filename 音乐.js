$(function (){
    ...
    function replace_music(obj){
        ...
        let audio = document.getElementById("audio");
        let id_m   
        let url_y='https://api.a20safe.com/api.php?api=10&key=51fe2465685127cbe503a8f9acbd7113&search='+name+'&type=so';    
        $('#time_begin').text('00:00')
        $('#time_end').text('00:00')
        $('.cut_one').css('left','-180px')
        clearTimeout(bug_out)
        ...
        $.ajax({
            ...
            success:function(data){
                 id_m=data['data'][0]['list'][0]['id']
            }
        })
        let url_mp3 = 'https://api.a20safe.com/api.php?api=10&key=51fe2465685127cbe503a8f9acbd7113&search='+id_m+'&type=song'
        audio.src=search_mp3(url_mp3)
        if_music=true
        time_i=0
        let im=$('#audio_img')
        $('#audio_img').remove()
